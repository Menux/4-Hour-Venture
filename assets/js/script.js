...
$(function() {
    ...
    // ## Count Down
    $("#countdown").countdown("2017/04/05 17:00:00", {elapse: true}).on('update.countdown', function(event) {
        if (event.elapsed && event.strftime('%H') === "06") {
            ...
            $(this).text(event.strftime('Noch %D Tage und %H:%M:%S bis zum 1.Four Hour Venture.'));
        }
    });
